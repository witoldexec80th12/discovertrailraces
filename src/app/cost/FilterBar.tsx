  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      <select
        ...
        className="rounded-lg border border-neutral-300 bg-white px-3 py-1.5 text-sm text-neutral-900 font-bold focus:outline-none focus:ring-2 focus:ring-neutral-400 cursor-pointer"
      >
